...
% -.------------------------------------------------------------
% Main do Nosso Projeto aqui é onde temos toda a interação com o utilizador e carregamos todas as funções e audios e enviamos para o utilizador os respetivos audios,efeitos,gráficos etc...
% -.------------------------------------------------------------
...
while true
    ...
    disp(['Áudio processado guardado como ' nome_arquivo_saida]);

    % Perguntar ao utilizador se deseja continuar
    continuar = input('Deseja processar outro áudio? (S/N): ', 's');
    if lower(continuar) ~= 's'
        disp('A sair do programa...');
        break;
    end
end
